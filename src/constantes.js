...
const ejerciciosPruebas=[
    new Ejercicio("Numeros Primos","Numeros",undefined,"resumen","detalle1")
    ,new Ejercicio("Numeros Romanos","Numeros","10PUZY7ai9akJ5VAGzWbPNKGjQXBQ4-f9","resumen2","detalle2")
